...
class GraphGCN(MessagePassing):
    def __init__(self, in_channels, out_channels, aggr='add',args=None):
    ...
    def forward(self, x, edge_index):
        ...
        # print(self.args.masking_ratio)
        mask = generate_random_mask(num_nodes, dim, mask_prob=self.args.masking_ratio)
        mask = mask.to("cuda:0")
